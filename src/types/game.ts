...
export interface WorldState extends FinanceWorldState,SportsWorldState,BusinessWorldState,NarrationWorldState,HealthWorldState,LegacyLegalWorldState{
  version:9;seed:number;date:string;character:Character;npcs:Npc[];relationships:RelationshipState[];
